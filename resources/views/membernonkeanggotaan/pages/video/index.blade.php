...
@section('title', 'Katalog Video Pembelajaran')
...
<div class="catalog-page">
    ...
    <section class="catalog-hero">
        <div class="catalog-hero__content">
            <span class="catalog-hero__eyebrow"><i class="fas fa-play-circle mr-1"></i> Video Streaming Academy</span>
            <h1 class="catalog-hero__title">Katalog Video Pembelajaran</h1>
            <p class="catalog-hero__description">
                Pelajari materi lewat panduan video tutorial interaktif, pembahasan studi kasus, dan modul kelas interaktif.
            </p>
        </div>
    </section>
    ...
    <div class="catalog-layout">
        {{-- Filter Card --}}
        <aside class="catalog-filter-card" aria-label="Filter Video">
            <h2 class="catalog-filter-card__title">Filter Video</h2>
            <p class="catalog-filter-card__subtitle">Cari materi video berdasarkan kata kunci.</p>

             <form method="GET" action="{{ url()->current() }}">
                {{-- Input Pencarian --}}
                <div class="catalog-filter-field">
                    <label for="ebook-search">Pencarian</label>
                    <input type="search" id="ebook-search" name="q" class="catalog-filter-control" value="{{ request('q') }}" placeholder="Cari judul ebook...">
                </div>
                ...
                <div class="catalog-filter-field">
                    ...
                    <select id="tipe-harga" name="tipe_harga" class="catalog-filter-control">
                        ...
                        <option value="berbayar" {{ request('tipe_harga') == 'berbayar' ? 'selected' : '' }}>Berbayar</option>
                    </select>
                </div>
             ...
             alt="Banner {{ $sub->nama }}">
                            ...
                            <div class="catalog-card__body">
                                ...
                                <p class="catalog-card__description">
                                    {{ Str::limit($sub->keterangan ?? 'Tidak ada deskripsi video.', 80) }}
                                </p>
                                ...
                                <div class="catalog-card__price-wrapper">
                                    ...
                                    @elseif($hargaFinal > 0)
                                       ...
                                       @if($hasDiscount)
                                        ...
                                        @endif
                                    @else
                                        <span class="catalog-card__price-final text-green-600">
                                            Gratis
                                        </span>
                                          @if($hasDiscount)
                                            <span class="catalog-card__price-original">
        ...
        Detail Video <i class="fas fa-arrow-right"></i>
            ...
            @else
                <div class="catalog-empty-state">
                    ...
                    <h3>Belum ada Video yang cocok</h3>
                    <p>Ubah kata kunci pencarian atau reset filter untuk melihat katalog video pembelajaran lainnya.</p>
                </div>
            @endif
        </section>
    </div>
