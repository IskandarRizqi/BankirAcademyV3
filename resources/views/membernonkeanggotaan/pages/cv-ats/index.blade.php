...
<div class="cv-page">
    ...
    <div class="empty-cv">
        ...
        <p>Lengkapi data diri, pendidikan, pengalaman kerja, dan sertifikasi untuk membuat CV ATS yang lebih siap digunakan.</p>
        ...
        <div class="row align-items-center cv-hero-content">
            <div class="col-12">
                ...
                <div class="cv-actions">
                    ...
                    <a href="{{ route('membernonanggota.cv-ats.pdf') }}" class="btn cv-print-button px-3" target="_blank" rel="noopener">
                        Cetak CV ATS
                    </a>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg-4 mb-4">
            <div class="cv-card">
                ...
                <section class="cv-section">
                    <h2 class="cv-section-title"><i class="fas fa-align-left" aria-hidden="true"></i> Ringkasan Profil</h2>
                    <p class="cv-summary">{{ $cv->pengalamanspesifik }}</p>
                </section>

                <section class="cv-section">
                    <h2 class="cv-section-title"><i class="fas fa-graduation-cap" aria-hidden="true"></i> Riwayat Pendidikan</h2>
                    @if($cv->perguruannama)
                    <div class="cv-item mb-3">
                        <h3 class="cv-item-title">{{ $cv->perguruannama }}</h3>
                        <p class="cv-item-subtitle">{{ $cv->perguruanfakultas }} · {{ $cv->perguruangelar }}</p>
        ...
        <div class="col-lg-8 mb-4">
            <div class="cv-card">
                <section class="cv-section">
                    <h2 class="cv-section-title"><i class="fas fa-briefcase" aria-hidden="true"></i> Pengalaman Kerja</h2>
                ...
                <section class="cv-section">
                    <h2 class="cv-section-title"><i class="fas fa-certificate" aria-hidden="true"></i> Pelatihan &amp; Sertifikasi</h2>
