    ...
    <section class="catalog-hero">
        <div class="catalog-hero__content">
            ...
            <p class="catalog-hero__description">
                Akses modul pembelajaran, jurnal, dan e-book berkualitas dalam format digital untuk menunjang kompetensi Anda.
            </p>
        </div>
    </section>
                            ...
                            <div class="catalog-card__body">
                                ...
                                <div class="catalog-card__footer">
                                    ...
                                    @if($sub->items->count() > 0)
                                        <a href="{{ route('ebook.belajar', [$sub->id]) }}" class="catalog-card__button">
