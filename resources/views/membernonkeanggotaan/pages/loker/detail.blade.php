            ...
            <section class="loker-detail-card loker-detail-info" aria-labelledby="loker-summary-title">
                ...
                <dl class="loker-detail-info-list">
                    <div class="loker-detail-info-item">
                        <span class="loker-detail-info-item__icon" aria-hidden="true"><i class="fas fa-map-marker-alt"></i></span>
                        <div>
                    ...
                    <div class="loker-detail-info-item">
                        <span class="loker-detail-info-item__icon" aria-hidden="true"><i class="fas fa-money-bill-wave"></i></span>
                        <div>
                            <dt>Estimasi gaji</dt>
                            <dd>
                    ...
                    <div class="loker-detail-info-item">
                        <span class="loker-detail-info-item__icon" aria-hidden="true"><i class="fas fa-calendar-alt"></i></span>
                        <div>
        ...
        <section class="loker-related" aria-labelledby="loker-related-title">
            ...
            <div class="loker-related-grid">
                @foreach($relatedLokers as $relatedLoker)
                    @include('membernonkeanggotaan.components.ui.loker-card', ['loker' => $relatedLoker])
                @endforeach
            </div>
        </section>
    @endif
