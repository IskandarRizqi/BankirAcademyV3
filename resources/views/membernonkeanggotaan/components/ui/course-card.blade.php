@php
    ...
    if ($startDate && $endDate) {
        ...
        if (
            now()
                ->startOfDay()
                ->greaterThan(\Carbon\Carbon::parse($startDate)->endOfDay())
        ) {
            $courseStatus = 'Completed';
            $courseStatusClass = 'completed';
        }
...
<article class="member-course-card {{ $courseStatusClass === 'completed' ? 'member-course-card--completed' : '' }}">
    ...
    <div class="member-course-card__body">
        <p class="member-course-card__category">
            ...
            <span
                class="member-course-card__category-badge member-course-card__category-badge--status-{{ $courseStatusClass }}">{{ $courseStatus }}</span>
        </p>
        ...
        <div class="member-course-card__meta" aria-label="Informasi kelas">
            ...
            <div class="member-course-card__meta-item">
                ...
                <span class="member-course-card__meta-value">
                    <span class="member-course-card__media-icon" tabindex="0" role="img"
                        aria-label="{{ $mediaTooltip }}" data-tooltip="{{ $mediaTooltip }}">
        ...
        <div class="member-course-card__footer">
            <div class="member-course-card__price">
                ...
                <span
                    class="member-course-card__price-value {{ $isPriceComingSoon ? 'member-course-card__price-value--coming-soon' : '' }}">{{ $priceLabel }}</span>
