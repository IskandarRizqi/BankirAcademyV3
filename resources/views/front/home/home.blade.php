                        ...
                        <div class="grid-inner row align-items-center no-gutters p-4">
                            ...
                            <div class="col-md-8 pl-md-4">
                                ...
                                <div class="entry-content">
                                    <a href="#" class="btn btn-secondary" disabled="disabled">Buy Tickets</a> <a href="/detail-kelas" class="btn btn-danger">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="entry col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="grid-inner">
                            <div class="entry-image">
                                <a href="#"><img src="{{asset('front/images/thumbs/1.jpg')}}" alt="Standard Post with Image"></a>
                            </div>
