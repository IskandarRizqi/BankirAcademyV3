...
<section id="content">
                                    ...
                                    <div class="tab-content clearfix" id="tab-feeds">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" type="checkbox" name="param_checked_lunas[]" value="0" {{
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" type="checkbox" name="param_checked_lunas[]" value="1" {{
                                                ...
                                                <div>
                                                    <span onclick="invoiceAjax()"><button class="btn btn-warning">Invoice</button></span>
                                                    <span class="btn btn-info" id="buktiMulti">Upload Bukti</span>
                                                    <p class="m-0">Pilih Checkbox Lalu Klik Button</p>
                                                </div>
                                            </div>
                                        </div>
                                        <form id="formmultiinvoice" action="/classes/multiinvoice" method="POST" location.reload(); target="_blank">
                                            @csrf
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <p hidden>
                                                        @if ($d->expired < \Carbon\Carbon::now()) {{ $expired=true }} @else {{ $expired=false }} @endif <tr class="text-center">
                                                    </p>
                                                    <td>
                                                        <div>
                                                    ...
                                                    <td class="longtextoverflow">
                                                        @if ($expired)
                                                        <input type="number" name="jmlPeserta[]" class="form-control" value="{{ $d->jumlah }}" readonly>
                                                        @else
                                                        @if ($d->file)
                                                        {{ $d->jumlah }} Order Peserta
                                                        @else
                                                        <input type="number" name="jmlPeserta[]" class="form-control" onchange="tambahPeserta('{{ $d->id }}','{{ $d->participant_limit }}','{{ $d->class_id }}',$(this).val(),@if (isset($pfl)){{ $pfl['referral'] ? $pfl['referral'] : '' }}@endif)" value="{{ $d->jumlah }}">
                                                        @endif
                                                        @endif
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        {{ $d->kode_promo }}
                                                        @else
                                                        <input type="text" name="kode_promo[]" class="form-control" onchange="kodePromo('{{ urlencode($d->title) }}',$(this).val(),'{{ $d->id }}')" @if ($expired) readonly @endif>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <div class="dropdown">
                                            ...
                                            <!-- Modal Multi Bukti-->
                                            <div class="modal fade" id="bayarMultiModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <form action="/multi-bayar" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            ...
                                                            <div class="modal-body">
                                                                <textarea name="dataInvoiceMulti" id="dataInvoiceMulti" cols="30" rows="10" required hidden></textarea>
                                                                <div class="col-lg-12 bottommargin">
                                                                    <label>Upload Bukti Multi Pembayaran:</label><br>
                                                                    <input id="inputimagebukti" name="imageBuktiMulti" type="file" class="file" data-show-upload="false" data-show-caption="true" data-show-preview="true" accept="image/*">
    ...
    <div class="modal fade" id="reviewFormModal" tabindex="-1" role="dialog" aria-labelledby="reviewFormModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row mb-0" id="template-reviewform" name="template-reviewform" action="/addreviewinstructor" method="post">
                        @csrf
                        <input type="text" name="instructor_id" id="instructor_id" hidden>
                        <div class="col-12 mb-3">
                            <label for="template-reviewform-rating">Rating</label>
                            <span id="nilai_value" class="ml-1"></span>
                            <input type="range" class="form-range form-control p-0" id="nilai_review" name="nilai" value="1" min="1" max="5" required>
                        ...
                        <div class="col-12 mb-3">
                            <label for="template-reviewform-comment">Comment
                                <small>*</small></label>
                            <textarea class="required form-control" id="template-reviewform-comment" name="comment" rows="6" cols="30" required></textarea>
                        </div>
                        @auth
                        <div class="col-12">
                            <button class="button button-3d m-0" type="submit" id="template-reviewform-submit" name="template-reviewform-submit" value="submit">Submit
                                Review</button>
                        </div>
                        @else
                        <div class="col-12">
    ...
    <div class="modal fade" id="modalCorporate" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="reviewFormModalLabel" aria-hidden="true" style="background-color: #000000cc">
                                ...
                                <form action="{{ route('profile.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            ...
                                            <input type="text" class="form-control" name="nama_lengkap" value="{{ isset($pfl['name'])?$pfl['name']:'' }}">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="nomor_handphone" value="{{ isset($pfl['phone'])?$pfl['phone']:'' }}">
                                            </div>
                                        ...
                                        <div class="col-lg-4" hidden>
                                            ...
                                            <input type="text" class="form-control" name="company" {{--
                                                value="{{ isset($pfl['instansi'])?$pfl['instansi']:'' }}" --}} value="perorangan">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <label for="form-control">Tanggal
                                                        lahir</label>
                                                    <input type="date" name="tanggal_lahir" class="form-control" value="{{ isset($pfl['tanggal_lahir'])?$pfl['tanggal_lahir']:'' }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <label for="form-control">Referral
                                                        (optional)</label>
                                                    <input type="text" id="referral" name="referral" class="form-control" onchange="referralKode('{{ isset($pfl['user_id'])?$pfl['user_id']:'' }}',$(this).val())" value="@if (isset($pfl['user_id'])){{ $pfl['referral'] ? $pfl['referral']['code'] : '' }}@endif" @if (isset($pfl['user_id'])){{ $pfl['referral'] ? 'readonly'
                                                        : '' }}@endif>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-9">
                                            ...
                                            <textarea class="form-control" name="alamat">{{ isset($pfl['description'])?$pfl['description']:'' }}</textarea>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <img id="pictureprv2" src="{{ isset($pfl['picture'])?$pfl['picture']:'' }}" alt="" width="80px">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                ...
                                <form action="{{ route('profile.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <select name="jenis_corporate" class="form-control jc" id="jenis_corporates" data-show-subtext="true" data-live-search="true" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <img id="pictureprv3" src="{{ isset($pfl['picture'])?$pfl['picture']:'' }}" alt="" width="80px">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
