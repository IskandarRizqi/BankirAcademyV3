                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <button id="btnInvoice" type="button"
                                                                    ...
                                                                    onclick="invoice({{ $d->id }})" title="Invoice">
                                                                    Invoice
                                                                </button>
                                                                @if ($d->status == 0)
                                                    ...
                                                    <div class="modal-content">
                                                        <form action="" method="GET" enctype="multipart/form-data"
                                                            ...
                                                            <div class="modal-body text-center">
                                                                <input type="text" id="payment_invoice"
                                                                    name="payment_invoice" hidden>
                                                                <input type="text" id="sertifikat_invoice"
                                                                    name="sertifikat_invoice" hidden>
                                                                ...
                                                                <div class="d-flex justify-content-center mt-4">
                                                                    <span class="btn btn-warning" target="_blank"
                                                                        title="Invoice"
                                                                        onclick="cetakInvoice()">Tidak</span>
                                                                    <span class="btn btn-primary ml-2" target="_blank"
                                                                        title="Invoice"
...
<script>
    ...
    $('#image_bukti_pembayaran').change(function(e) {
        getImgData(this, '#pctrbuktipembayaran');
    });
