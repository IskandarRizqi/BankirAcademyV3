                    ...
                    <div class="form-group col-md-2">
                        ...
                        <select class="form-control tagging slc2tag" name="slcClassesCategory" id="slcClassesCategory">
                            ...
                            @foreach ($pencarian['category'] as $ctg)
                                <option value="{{ $ctg }}"
                                    @if (isset($slcClassesCategory)) {{ $slcClassesCategory == $ctg ? 'selected' : '' }} @endif>
                                    {{ $ctg }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group col-md-2">
                        ...
                        <select class="form-control tagging" name="instructor" id="instructor">
                            ...
                            @foreach ($pencarian['instructor'] as $key => $ctg)
                                <option value="{{ $ctg }}"
                                    @if (isset($instructor)) {{ $instructor == $ctg ? 'selected' : '' }} @endif>
                                    {{ $key }}</option>
                            @endforeach
                        </select>
                    </div>
                                            ...
                                            <div>
                                                <div class="col d-flex">
                                                    <input id="checkbox-{{ $key }}" class="checkbox-style"
                                                        ...
                                                        @if (isset($tags)) {{ array_key_exists($ctg, $tags) ? 'checked' : '' }} @endif>
                                            ...
                                            <div>
                                                <div class="col d-flex">
                                                    <input id="jenis-{{ $key }}" class="checkbox-style"
                                                        ...
                                                        @if (isset($jeniss)) {{ array_key_exists($ctg, $jeniss) ? 'checked' : '' }} @endif>
                                                    <label for="jenis-{{ $key }}"
                                                        class="checkbox-style-1-label">{{ $ctg }}</label>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <div class="col d-flex">
                                                    <input id="tipe-{{ $key }}" class="checkbox-style"
                                                        ...
                                                        @if (isset($tipe)) {{ array_key_exists($ctg, $tipe) ? 'checked' : '' }} @endif>
                                                    <label for="tipe-{{ $key }}"
                                                        class="checkbox-style-1-label">{{ $ctg }}</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <a href="/profile-instructor/3/Dani" class="d-flex mt-2">
                                                    ...
                                                    <div class="">
                                                        <label
                                                            class="d-block mb-0">{{ $v['instructor_list'][0]->name }}
