   <!-- start header -->
        <header class="header-with-topbar">
         ...
         <div class="header-top-bar bg-white text-center py-2">
        <div class="fs-14 text-dark-gray">
             Upgrade Skill Tanpa Batas, Lampaui Batas! <strong>#Bankir Hebat</strong>
            {{-- <a href="demo-consulting-contact.html" class="text-base-color fw-500 text-decoration-line-bottom">Contact now</a>  --}}
                ...
                <div class="container-fluid">
                    <div class="col-auto col-lg-2 me-auto">
                        <a class="navbar-brand" href="demo-consulting.html">
                            <img src="{{asset('FE/images/images-demo-consulting-logo-white.png')}}" data-at2x="FE/images/demo-consulting-logo-white@2x.png" alt="" class="default-logo">
                            <img src="{{asset('FE/images/images-demo-consulting-logo-black.png')}}" data-at2x="FE/images/demo-consulting-logo-black@2x.png" alt="" class="alt-logo">
                            <img src="{{asset('FE/images/images-demo-consulting-logo-black.png')}}" data-at2x="FE/images/demo-consulting-logo-black@2x.png" alt="" class="mobile-logo"> 
                        </a>
                    </div>
                    <div class="col-auto col-lg-8 menu-order position-static">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="navbarNav"> 
                            <ul class="navbar-nav alt-font" style="color: red"> 
                                <li class="nav-item"><a href="demo-consulting.html" class="nav-link">Home</a></li>
                                <li class="nav-item"><a href="/promo" class="nav-link" style="color: red">Company</a></li>
