                    ...
                    <div class="row text-white text-capitalize" style="margin-top: 20px;">
                        ...
                        <div class="col-md-4 col-12 mb-2">
                                <div class="form-group m-0">
                                    ...
                                    <p class="m-0" style="font-size: 13px;"><b>07:00 WIB</b></p>
                                </div>
                        </div>
                    ...
                    <div class="row text-white text-capitalize" style="margin-top: 20px;">
                        <div class="col-md-12 col-12 mb-2">
                                <div class="form-group m-0">
                                    ...
                                    <p class="m-0" style="font-size: 13px;">
                                        <a href="https://www.google.com/maps/place/Jalan+Contoh+No+1" target="_blank" style="color: inherit; text-decoration: none;font-size: 13px;">
                                            <i class="fa fa-map-marker-alt" aria-hidden="true"></i> Jalan Contoh No 1 K
                                        </a>
                                    </p>
