<style>
    ...
    .price-tag {
        font-size: 1.75rem;
        font-weight: 800;
        color: #2b3a41; /* Fix typo dari #2b3h41 */
    }
    ...
    /* Styling khusus Area Menunggu Konfirmasi */
    .pending-member-box {
        background: linear-gradient(135deg, #ff9900 0%, #ff5e62 100%);
        color: white;
        border-radius: 20px;
        padding: 40px;
        box-shadow: 0 10px 25px rgba(255, 94, 98, 0.15);
    }
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    <div class="active-member-box text-center">
                        ...
                        <h2 class="font-weight-bold mb-2 text-white">Halo, Selamat Datang Member Premium!</h2>
