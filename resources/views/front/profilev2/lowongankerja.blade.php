                    ...
                    <div class="col-md-5 text-right">
                        ...
                        <div class="mt-2">
                            ...
                            <button class="button button-mini button-border button-circle button-yellow"
                                onclick="kirimloker('{{$value->id}}')">Kirim Lamaran</button>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    setTimeout(() => {
                        ...
                        data.data.lamaran.forEach(v => {
                            ...
                            html+='            <div class="col-md-2">';
                                ...
                                html += '    <img src="/image/loker/'+image+'" alt="" style="">';
                            html+='            </div>';
                            ...
                            html+='                    <strong>'+nama+'</strong>';
                            html+='                </p>';
                            html+='                <p class="">'+v.lamaran.title
                            html+='                </p>';
                            html+='                <div class="mt-2">';
                            html+='                    <svg width="16" height="21" viewBox="0 0 16 21" fill="none" xmlns="http://www.w3.org/2000/svg">';
                            html+='                        <path';
                            html+='                            d="M7.99995 11.6365C7.28074 11.6365 6.57769 11.4232 5.97969 11.0237C5.3817 10.6241 4.91562 10.0562 4.64039 9.39171C4.36516 8.72725 4.29315 7.9961 4.43346 7.29071C4.57377 6.58533 4.9201 5.93739 5.42865 5.42884C5.93721 4.92028 6.58515 4.57395 7.29053 4.43364C7.99591 4.29333 8.72707 4.36535 9.39152 4.64057C10.056 4.9158 10.6239 5.38188 11.0235 5.97988C11.423 6.57787 11.6363 7.28093 11.6363 8.00013C11.6352 8.9642 11.2517 9.88845 10.57 10.5702C9.88827 11.2519 8.96402 11.6353 7.99995 11.6365ZM7.99995 5.81832C7.56843 5.81832 7.14659 5.94628 6.7878 6.18602C6.429 6.42576 6.14935 6.76651 5.98421 7.16519C5.81908 7.56386 5.77587 8.00255 5.86006 8.42578C5.94424 8.84901 6.15204 9.23778 6.45717 9.54291C6.7623 9.84804 7.15107 10.0558 7.5743 10.14C7.99753 10.2242 8.43622 10.181 8.83489 10.0159C9.23357 9.85073 9.57432 9.57108 9.81406 9.21228C10.0538 8.85349 10.1818 8.43165 10.1818 8.00013C10.1812 7.42166 9.95113 6.86704 9.54209 6.45799C9.13304 6.04895 8.57842 5.81889 7.99995 5.81832Z"';
                            html+='                            fill="#979797" />';
                            html+='                        <path';
                            html+='                            d="M8 20.3636L1.86473 13.128C1.77948 13.0193 1.69512 12.91 1.61164 12.8C0.56363 11.4195 -0.00253177 9.73324 8.51118e-06 7.99999C8.51118e-06 5.87826 0.842863 3.84343 2.34315 2.34314C3.84344 0.842854 5.87827 0 8 0C10.1217 0 12.1566 0.842854 13.6568 2.34314C15.1571 3.84343 16 5.87826 16 7.99999C16.0025 9.73246 15.4366 11.4179 14.3891 12.7978L14.3884 12.8C14.3884 12.8 14.1702 13.0865 14.1374 13.1251L8 20.3636ZM2.7731 11.9236C2.7731 11.9236 2.94255 12.1476 2.9811 12.1956L8 18.1149L13.0254 12.1876C13.0574 12.1476 13.2284 11.9214 13.2284 11.9214C14.0845 10.7935 14.5471 9.41601 14.5454 7.99999C14.5454 6.26403 13.8558 4.59917 12.6283 3.37166C11.4008 2.14415 9.73596 1.45454 8 1.45454C6.26404 1.45454 4.59918 2.14415 3.37167 3.37166C2.14416 4.59917 1.45455 6.26403 1.45455 7.99999C1.45303 9.41689 1.91621 10.7952 2.7731 11.9236Z"';
                            html+='                            fill="#979797" />';
                            html+='                    </svg>'+v.lamaran.alamat?v.lamaran.alamat:'';
                            html+='                </div>';
                            html+='            </div>';
                            html+='            <div class="col-md-5 text-right">';
                            html+='                <p class="m-0">';
                            html+='                    <strong>'+v.tanggal_date+'</strong>';
                            html+='                </p>';
                            html+='                <span class="badge badge-info text-white"><svg width="14" height="14" viewBox="0 0 14 14"';
                            html+='                        fill="none" xmlns="http://www.w3.org/2000/svg">';
                            html+='                        <path';
                            html+='                            d="M5.88173 9.74554L3.18164 7.04482L4.08146 6.145L5.88173 7.94464L9.481 4.34473L10.3815 5.24518L5.88173 9.74554Z"';
                            html+='                            fill="#fff" />';
                            ...
                            html+='                    </svg>';
                            html+='                    Dilamar</span>';
                            html+='            <button class="button button-mini button-border button-circle button-yellow" onclick="kirimloker('+v.id+')">Kirim Lamaran</button>';
                            // html+='                <div class="mt-2">';
                            // html+='                    <p class="text-secondary m-0">Lowongan sudah tutup</p>';
                            // html+='                </div>';
                            html+='            </div>';
                            html+='        </div>';
                            html+='    </div>';
