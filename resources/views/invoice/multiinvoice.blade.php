            ...
            <main>
                    ...
                    <div class="float-right invoice-details">
                        <div class="col-lg-6">
                            <div class="date">Tanggal Invoice
                                :{{Carbon\Carbon::parse($payment[0]->tanggal)->format('d-m-Y')}}</div>
                            <h2 class="invoice-id">No. Invoice : <span
                                    style="text-transform: uppercase;">{{$no_invoice}}</span></h2>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="unit">{{substr(numfmt_format_currency(numfmt_create('id_ID',
                                \NumberFormatter::CURRENCY),$p->price,"IDR"),0,-3) }}</td>
                            <td class="unit">
                            ...
                            <td class="unit">
                                @if ($p->promo)
                                {{substr(numfmt_format_currency(numfmt_create('id_ID',
                                \NumberFormatter::CURRENCY),$p->promo,"IDR"),0,-3)}}
                                @endif
                            </td>
                            <td class="unit">
                                {{substr(numfmt_format_currency(numfmt_create('id_ID',
                            ...
                            <td class="unit">
                                {{substr(numfmt_format_currency(numfmt_create('id_ID',
                                \NumberFormatter::CURRENCY),$p->totalAkhir,"IDR"),0,-3)
                                }}
                            </td>
                        </tr>
                        @endforeach
                ...
                <div style="text-align: right">
                    <h2>Grand Total : {{substr(numfmt_format_currency(numfmt_create('id_ID',
                        \NumberFormatter::CURRENCY),$total,"IDR"),0,-3)
                        }}</h2>
