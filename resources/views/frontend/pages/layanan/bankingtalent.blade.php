...
<div id="content-area">
	...
	<section style="background:var(--system_primary_color, linear-gradient(173.69deg, #660AFB 26.21%, #A737FF 81.64%)); padding:70px 20px; display:flex; flex-wrap:wrap; align-items:center; justify-content:center; color:white; text-align:left;">
		...
		<div style="flex:1 1 400px; max-width:600px; padding:10px 20px; width:100%;">
			...
			<ul style="list-style:none; padding:0; margin:0;">
				<li style="display:flex; align-items:flex-start; margin-bottom:15px;">
					<span style="color:white; border-radius:50%; width:22px; height:22px; display:flex; align-items:center; justify-content:center; font-size:13px; margin-right:12px; flex-shrink:0;">✔</span>
