...
@section('page-title')
    Dasar Tata Kelola dan Audit TI Perbankan — Bankir Academy
@endsection

@section('page-description')
    Memahami tata kelola TI, kontrol umum, risiko, dokumentasi, audit, dan tindak lanjut perbaikan.
@endsection
        ...
        <div class="container detail-grid">
            <div>
                <div class="breadcrumb"><a href="{{ route('frontend.home') }}">Beranda</a><span>›</span><a
                        href="{{ route('frontend.classes.index') }}">Kelas Online</a><span>›</span><span>Teknologi
                        Informasi</span></div>
                <span class="eyebrow">Teknologi Informasi</span>
                <h1>Dasar Tata Kelola dan Audit TI Perbankan</h1>
                <p class="hero-copy">Memahami tata kelola TI, kontrol umum, risiko, dokumentasi, audit, dan tindak lanjut
                    perbaikan.</p>
                <div class="hero-meta"><span>Level Lanjutan</span><span>Blended</span><span>Studi Kasus</span><span>7 modul ·
                        ±5,5 jam belajar</span></div>
            ...
            <div class="preview-card">
                <div class="preview-cover theme-blue"><span
                        class="preview-label">Teknologi Informasi</span>
                    <h2>Dasar Tata Kelola dan Audit TI Perbankan</h2>
                    <div class="preview-bottom">
                        <div class="preview-stat"><strong>Level Lanjutan</strong><span>Tingkat pembelajaran</span></div>
    ...
    <section class="section" id="ringkasan">
        <div class="container overview-grid">
            <article class="content-card"><span class="eyebrow">Tentang Kelas</span>
                ...
                <p>Memahami tata kelola TI, kontrol umum, risiko, dokumentasi, audit, dan tindak lanjut perbaikan. Materi
                    disusun bertahap agar peserta dapat memahami konsep, melihat contoh penerapan, menguji pemahaman, dan
                    menyusun langkah tindak lanjut yang relevan.</p>
                <div class="outcome-grid" id="hasil-belajar">
                    <article class="outcome-card"><i>✓</i><strong>IT governance</strong></article>
                    <article class="outcome-card"><i>✓</i><strong>Kontrol dan bukti audit</strong></article>
                    <article class="outcome-card"><i>✓</i><strong>Temuan dan action plan</strong></article>
                </div>
            </article>
            <aside class="side-info">
                <div class="info-row"><i>👥</i><span><strong>Target Peserta</strong><span>Tim TI, audit internal, manajemen
                            risiko, kepatuhan, pejabat pengawas, dan pimpinan.</span></span></div>
                <div class="info-row"><i>◷</i><span><strong>Durasi</strong><span>7 modul · ±5,5 jam belajar</span></span>
                </div>
    ...
    'description' => 'Urutan modul dapat disesuaikan saat kelas dikembangkan menjadi program institusi atau blended learning.',
            ...
            <div class="module-list">
                <article class="module"><span class="module-no">01</span>
                    <div>
                        <h3>Fondasi Tata Kelola TI</h3>
                        <p>Peran direksi, komisaris, komite, unit TI, dan three lines.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">02</span>
                    <div>
                        <h3>Kebijakan dan Prosedur TI</h3>
                        <p>Arsitektur dokumen, persetujuan, sosialisasi, review, dan bukti.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">03</span>
                    <div>
                        <h3>IT General Controls</h3>
                        <p>Akses, perubahan, operasi, backup, keamanan, dan vendor.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">04</span>
                    <div>
                        <h3>Manajemen Risiko TI</h3>
                        <p>Identifikasi aset, ancaman, kerentanan, dampak, dan mitigasi.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">05</span>
                    <div>
                        <h3>Perencanaan Audit TI</h3>
                        <p>Tujuan, ruang lingkup, kriteria, sampel, dan program audit.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">06</span>
                    <div>
                        <h3>Bukti dan Temuan Audit</h3>
                        <p>Kecukupan bukti, kondisi, kriteria, sebab, dampak, dan rekomendasi.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">07</span>
                    <div>
                        <h3>Tindak Lanjut</h3>
                        <p>Action plan, PIC, target, validasi, eskalasi, dan penutupan.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
            </div>
        </div>
    ...
    'description' => 'Pilih topik berikut untuk memperluas kompetensi secara bertahap.',
            ...
            <div class="related-grid">
                ...
                <article class="related">
                    ...
                    <div class="related-body">
                        <p>Memahami fungsi bank, produk dan layanan, struktur organisasi, proses operasional, serta etika
                            dasar calon bankir.</p><a
                            href="{{ route('frontend.class.static', ['slug' => 'kelas-general-banking-fundamentals']) }}">Lihat
                            kelas →</a>
                    </div>
                </article>
                <article class="related">
