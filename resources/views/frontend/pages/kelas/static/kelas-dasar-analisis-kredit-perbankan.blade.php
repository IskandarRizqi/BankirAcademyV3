...
@section('page-title')
    Dasar Analisis Kredit Perbankan — Bankir Academy
@endsection

@section('page-description')
    Mengenal proses kredit, analisis sederhana, dokumen pendukung, identifikasi risiko, dan prinsip kehati-hatian.
@endsection
        ...
        <div class="container detail-grid">
            <div>
                <div class="breadcrumb"><a href="{{ route('frontend.home') }}">Beranda</a><span>›</span><a
                        href="{{ route('frontend.classes.index') }}">Kelas Online</a><span>›</span><span>Kredit &amp;
                        Risiko</span></div>
                <span class="eyebrow">Kredit &amp; Risiko</span>
                <h1>Dasar Analisis Kredit Perbankan</h1>
                <p class="hero-copy">Mengenal proses kredit, analisis sederhana, dokumen pendukung, identifikasi risiko, dan
                    prinsip kehati-hatian.</p>
                <div class="hero-meta"><span>Level Dasar</span><span>Mandiri</span><span>Studi Kasus</span><span>7 modul · ±5
            ...
            <div class="preview-card">
                <div class="preview-cover theme-teal"><span
                        class="preview-label">Kredit &amp; Risiko</span>
                    <h2>Dasar Analisis Kredit Perbankan</h2>
        ...
        <div class="container overview-grid">
            <article class="content-card"><span class="eyebrow">Tentang Kelas</span>
                ...
                <p>Mengenal proses kredit, analisis sederhana, dokumen pendukung, identifikasi risiko, dan prinsip
                    kehati-hatian. Materi disusun bertahap agar peserta dapat memahami konsep, melihat contoh penerapan,
                    menguji pemahaman, dan menyusun langkah tindak lanjut yang relevan.</p>
                <div class="outcome-grid" id="hasil-belajar">
                    <article class="outcome-card"><i>✓</i><strong>Alur proses kredit</strong></article>
                    <article class="outcome-card"><i>✓</i><strong>Analisis 5C sederhana</strong></article>
                    <article class="outcome-card"><i>✓</i><strong>Risiko dan mitigasi awal</strong></article>
                </div>
            </article>
            <aside class="side-info">
                <div class="info-row"><i>👥</i><span><strong>Target Peserta</strong><span>Account officer pemula, staf
                            kredit, calon analis kredit, dan pegawai BPR/BPRS.</span></span></div>
    ...
    'description' => 'Urutan modul dapat disesuaikan saat kelas dikembangkan menjadi program institusi atau blended learning.',
            ...
            <div class="module-list">
                <article class="module"><span class="module-no">01</span>
                    <div>
                        <h3>Gambaran Proses Kredit</h3>
                        <p>Tahap permohonan, analisis, keputusan, pencairan, monitoring, dan penyelesaian.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">02</span>
                    <div>
                        <h3>Tujuan dan Jenis Kredit</h3>
                        <p>Kredit modal kerja, investasi, konsumtif, serta kesesuaian kebutuhan debitur.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">03</span>
                    <div>
                        <h3>Pengumpulan Data Debitur</h3>
                        <p>Identitas, legalitas, usaha, keuangan, agunan, dan informasi pendukung.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">04</span>
                    <div>
                        <h3>Analisis 5C</h3>
                        <p>Character, Capacity, Capital, Collateral, dan Condition secara sederhana.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">05</span>
                    <div>
                        <h3>Analisis Arus Kas</h3>
                        <p>Sumber pembayaran, kemampuan bayar, simulasi angsuran, dan sensitivitas.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">06</span>
                    <div>
                        <h3>Identifikasi Risiko</h3>
                        <p>Red flags, mitigasi, dokumentasi, dan prinsip kehati-hatian.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">07</span>
                    <div>
                        <h3>Studi Kasus Kredit</h3>
                        <p>Latihan menyusun ringkasan analisis dan rekomendasi awal.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
            </div>
        </div>
