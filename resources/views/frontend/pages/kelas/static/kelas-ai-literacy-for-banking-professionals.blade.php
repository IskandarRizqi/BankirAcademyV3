...
@section('page-title')
    AI Literacy for Banking Professionals — Bankir Academy
@endsection

@section('page-description')
    Pengenalan penggunaan AI sebagai alat bantu kerja, batas penggunaan, verifikasi manusia, keamanan informasi, dan tata
    kelola dasar.
@endsection
        ...
        <div class="container detail-grid">
            <div>
                <div class="breadcrumb"><a href="{{ route('frontend.home') }}">Beranda</a><span>›</span><a
                        href="{{ route('frontend.classes.index') }}">Kelas Online</a><span>›</span><span>Digital
                        Banking</span></div>
                <span class="eyebrow">Digital Banking</span>
                <h1>AI Literacy for Banking Professionals</h1>
                <p class="hero-copy">Pengenalan penggunaan AI sebagai alat bantu kerja, batas penggunaan, verifikasi manusia,
                    keamanan informasi, dan tata kelola dasar.</p>
                <div class="hero-meta"><span>Level Menengah</span><span>Mandiri</span><span>Digital Skill</span><span>6 modul
                        · ±4,5 jam belajar</span></div>
            ...
            <div class="preview-card">
                <div class="preview-cover theme-red"><span class="preview-label">Digital Banking</span>
                    <h2>AI Literacy for Banking Professionals</h2>
        ...
        <div class="container overview-grid">
            <article class="content-card"><span class="eyebrow">Tentang Kelas</span>
                ...
                <p>Pengenalan penggunaan AI sebagai alat bantu kerja, batas penggunaan, verifikasi manusia, keamanan
                    informasi, dan tata kelola dasar. Materi disusun bertahap agar peserta dapat memahami konsep, melihat
                    contoh penerapan, menguji pemahaman, dan menyusun langkah tindak lanjut yang relevan.</p>
                <div class="outcome-grid" id="hasil-belajar">
                    <article class="outcome-card"><i>✓</i><strong>Prompt kerja yang efektif</strong></article>
                    <article class="outcome-card"><i>✓</i><strong>Verifikasi keluaran AI</strong></article>
                    <article class="outcome-card"><i>✓</i><strong>Privasi dan tata kelola</strong></article>
                </div>
            </article>
            <aside class="side-info">
                <div class="info-row"><i>👥</i><span><strong>Target Peserta</strong><span>Pegawai bank, supervisor, manajer,
                            tim operasional, pemasaran, risiko, dan human capital.</span></span></div>
                <div class="info-row"><i>◷</i><span><strong>Durasi</strong><span>6 modul · ±4,5 jam belajar</span></span>
                </div>
        ...
        <div class="container">
            ...
            <div class="module-list">
                <article class="module"><span class="module-no">01</span>
                    <div>
                        <h3>Dasar AI Generatif</h3>
                        <p>Cara kerja umum, kemampuan, keterbatasan, dan contoh penggunaan.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">02</span>
                    <div>
                        <h3>Prompt untuk Pekerjaan</h3>
                        <p>Menyusun konteks, tujuan, format, batasan, dan contoh keluaran.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">03</span>
                    <div>
                        <h3>Verifikasi dan Human Review</h3>
                        <p>Pemeriksaan fakta, logika, bias, sumber, dan keputusan manusia.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">04</span>
                    <div>
                        <h3>Privasi dan Kerahasiaan</h3>
                        <p>Klasifikasi data, larangan memasukkan data sensitif, serta kontrol akses.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">05</span>
                    <div>
                        <h3>Use Case Perbankan</h3>
                        <p>Ringkasan dokumen, ide konten, bantuan analisis, dan knowledge assistant.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
                <article class="module"><span class="module-no">06</span>
                    <div>
                        <h3>Tata Kelola Penggunaan AI</h3>
                        <p>Kebijakan internal, dokumentasi, pengujian, eskalasi, dan evaluasi risiko.</p>
                    </div><span class="module-time">± 30–45 menit</span>
                </article>
            </div>
        </div>
            ...
            <div class="related-grid">
                <article class="related">
                    <div class="related-cover theme-indigo">
                        <h3>APU PPT untuk Pegawai BPR/BPRS</h3>
                    </div>
                    <div class="related-body">
                        <p>Memahami prinsip APU PPT, pengenalan nasabah, pemantauan transaksi, pelaporan, dan tanggung jawab
                            pegawai.</p><a
                            href="{{ route('frontend.class.static', ['slug' => 'kelas-apu-ppt-untuk-pegawai-bpr-bprs']) }}">Lihat
                            kelas →</a>
                    </div>
                </article>
                <article class="related">
