		<div class="aoraeditor-skip aoraeditor-header">
						...
						<div class="col-12">
							<div class="d-flex align-items-center justify-content-between">
									...
									<div class="heading-category">
										<!-- <div class="heading-category-inner d-flex align-items-center" id="showCateDrop">
											<svg width="20" height="20" viewBox="0 0 20 20" fill="none"
												...
												<defs>
													<linearGradient id="paint0_linear_2444_2023" x1="0.524525"
														y1="3.89978" x2="5.51755" y2="2.76128"
														gradientUnits="userSpaceOnUse">
														<stop stop-color="var(--system_primery_gredient1)" />
														<stop offset="1" stop-color="var(--system_primery_gredient2)" />
													</linearGradient>
													<linearGradient id="paint1_linear_2444_2023" x1="7.47774"
														y1="3.89978" x2="12.4715" y2="2.76091"
														gradientUnits="userSpaceOnUse">
														<stop stop-color="var(--system_primery_gredient1)" />
														<stop offset="1" stop-color="var(--system_primery_gredient2)" />
													</linearGradient>
													<linearGradient id="paint2_linear_2444_2023" x1="0.524525"
														y1="10.8522" x2="5.51721" y2="9.71295"
														gradientUnits="userSpaceOnUse">
														<stop stop-color="var(--system_primery_gredient1)" />
														<stop offset="1" stop-color="var(--system_primery_gredient2)" />
													</linearGradient>
													<linearGradient id="paint3_linear_2444_2023" x1="7.47774"
														y1="10.8522" x2="12.4712" y2="9.71258"
														gradientUnits="userSpaceOnUse">
														<stop stop-color="var(--system_primery_gredient1)" />
														<stop offset="1" stop-color="var(--system_primery_gredient2)" />
													</linearGradient>
													<linearGradient id="paint4_linear_2444_2023" x1="14.4309"
														y1="3.89978" x2="19.4247" y2="2.76091"
														gradientUnits="userSpaceOnUse">
														<stop stop-color="var(--system_primery_gredient1)" />
														<stop offset="1" stop-color="var(--system_primery_gredient2)" />
													</linearGradient>
													<linearGradient id="paint5_linear_2444_2023" x1="14.4309"
														y1="10.8522" x2="19.4243" y2="9.71258"
														gradientUnits="userSpaceOnUse">
														<stop stop-color="var(--system_primery_gredient1)" />
														<stop offset="1" stop-color="var(--system_primery_gredient2)" />
													</linearGradient>
													<linearGradient id="paint6_linear_2444_2023" x1="0.524525"
														y1="18.1006" x2="5.51763" y2="16.9623"
														gradientUnits="userSpaceOnUse">
														<stop stop-color="var(--system_primery_gredient1)" />
														<stop offset="1" stop-color="var(--system_primery_gredient2)" />
													</linearGradient>
													<linearGradient id="paint7_linear_2444_2023" x1="7.47774"
														y1="18.1006" x2="12.4716" y2="16.962"
														gradientUnits="userSpaceOnUse">
														<stop stop-color="var(--system_primery_gredient1)" />
														<stop offset="1" stop-color="var(--system_primery_gredient2)" />
													</linearGradient>
													<linearGradient id="paint8_linear_2444_2023" x1="14.4309"
														y1="18.1006" x2="19.4247" y2="16.962"
														gradientUnits="userSpaceOnUse">
														<stop stop-color="var(--system_primery_gredient1)" />
														<stop offset="1" stop-color="var(--system_primery_gredient2)" />
													</linearGradient>
										...
										<!-- <div class="heading-category-dropdown" id="cateDropDown">
											<ul>
												<li>
													<a href="courses818f.html?category_id[]=1">
														<span>Business</span>
														<i class="ti ti-angle-right"></i>
													</a>
													<ul>
														<li>
															<a href="courses5ffc.html?category_id[]=6">Accounting</a>
														</li>
														<li>
															<a href="courses2a31.html?category_id[]=7">MBA</a>
														</li>
													</ul>
												</li>
												<li>
													<a href="courses8aad.html?category_id[]=2">
														<span>3D Modeling</span>
														<i class="ti ti-angle-right"></i>
													</a>
													<ul>
														<li>
															<a href="courses8ec8.html?category_id[]=8">Blender
																Creator</a>
														</li>
														<li>
															<a href="coursesd020.html?category_id[]=9">3D
																Environments</a>
														</li>
													</ul>
												</li>
												<li>
													<a href="courses8a74.html?category_id[]=3">
														<span>UI UX Design</span>
														<i class="ti ti-angle-right"></i>
													</a>
													<ul>
														<li>
															<a href="courses0601.html?category_id[]=10">Adobe XD</a>
														</li>
														<li>
															<a href="courses3b3a.html?category_id[]=11">UI Design</a>
														</li>
													</ul>
												</li>
												<li>
													<a href="coursesa7ce.html?category_id[]=4">
														<span>Mobile Development</span>
														<i class="ti ti-angle-right"></i>
													</a>
													<ul>
														<li>
															<a href="courses7b89.html?category_id[]=12">App
																Development</a>
														</li>
													</ul>
												</li>
												<li>
													<a href="courses950f.html?category_id[]=5">
														<span>Software Development</span>
														<i class="ti ti-angle-right"></i>
													</a>
													<ul>
														<li>
															<a href="courses5506.html?category_id[]=13">Python</a>
														</li>
														<li>
															<a href="courses47aa.html?category_id[]=14">iOS
																Development</a>
														</li>
														<li>
															<a href="courses4ba9.html?category_id[]=15">Laravel</a>
														</li>
													</ul>
												</li>
											</ul>
								...
								<div class="d-flex align-items-center gap-3 flex-grow-1 justify-content-end">
									...
									<div
										class="heading-end d-flex align-items-center justify-content-end gap-2 gap-lg-3">
				...
				<div class="offcanvas-body">
					<ul class="heading-nav">
						...
						<li class="heading-list   ">
							<a class="heading-links" href="{{ url('/') }}">Beranda</a>
						</li>
						<li class="heading-list   ">
							<a class="heading-links" href="#">Layanan</a>
							<ul class="submenu list">
								<li class=""><a href="/pages/Banking-Solution">Banking Solution
									</a>
								</li>
								<li class=""><a href="/pages/Capacity-Building">Capacity Building
									</a>
								</li>
								<li class=""><a href="/pages/Talent-Solution">Banking Talent Solution
									</a>
								</li>
							</ul>
						</li>
						...
						<li class="heading-list   ">
							<a class="heading-links" href="#">Bakti Pendidikan</a>
						</li>

						<li class="heading-list   ">
							<a class="heading-links" href="#">Bakti UMKM</a>
						</li>
						<li class="heading-list   ">
							<a class="heading-links" href="/loker">Loker Bankir</a>
						</li>
			...
			<div class="heading_icons">
				<ul class="d-flex align-items-center">
					...
					<li class="flex-grow-1 text-center"><a href="my-cart.html">
							<svg xmlns="http://www.w3.org/2000/svg" width="24.036" height="23.972"
								viewBox="0 0 24.036 23.972">
