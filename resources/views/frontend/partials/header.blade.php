    ...
    <header class="site-header" id="siteHeader">
      <div class="container header-inner">
        ...
        <nav aria-label="Navigasi utama" class="desktop-nav">
          ...
          <div class="nav-item">
            <a class="nav-link" href="{{ route('frontend.home') }}#layanan"
              >Layanan <span class="chevron">▼</span></a
            >
            <div class="dropdown wide">
              <a class="drop-link" href="{{ route('frontend.service.banking-solution') }}">
                ...
                <span
                  ...
                  ><span
                    >Solusi terapan untuk kebutuhan operasional dan pengembangan
                    bank.</span
                  ></span
                >
              </a>
              <a class="drop-link" href="{{ route('frontend.service.capacity-building') }}">
                ...
                <span
                  ...
                  ><span
                    >Program peningkatan kompetensi berbasis kebutuhan
                    organisasi.</span
                  ></span
                >
              </a>
              <a class="drop-link" href="{{ route('frontend.service.banking-talent') }}">
                ...
                <span
                  ...
                  ><span
                    >Pengembangan dan pemetaan talenta sektor perbankan.</span
                  ></span
                >
              </a>
              <a class="drop-link" href="{{ route('frontend.service.lms') }}">
                ...
                <span
                  ...
                  ><span
                    >Pembelajaran digital, asesmen, dan pelaporan
                    terintegrasi.</span
                  ></span
                >
              </a>
              <a class="drop-link" href="{{ route('frontend.service.innovation') }}">
                ...
                <span
                  ...
                  ><span
                    >Riset, analisis produk, automasi, dan pengembangan AI
                    terapan.</span
                  ></span
                >
              </a>
              <a class="drop-link" href="{{ route('frontend.service.csr') }}">
                ...
                <span
                  ...
                  ><span
                    >Edukasi industri perbankan bagi pelajar dan calon
                    bankir.</span
                  ></span
                >
              </a>
          ...
          <div class="nav-item">
            <a class="nav-link" href="{{ route('frontend.home') }}#talent-solutions"
              >Talent Solutions <span class="chevron">▼</span></a
            >
            <div class="dropdown">
              <a class="drop-link" href="{{ route('frontend.talent.headhunting') }}">
                ...
                <span
                  ...
                  ><span
                    >Pencarian kandidat sesuai kriteria dan kebutuhan
                    organisasi.</span
                  ></span
                >
              </a>
              <a class="drop-link" href="{{ route('frontend.talent.outsourcing') }}">
                ...
                <span
                  ...
                  ><span
                    >Dukungan tenaga kerja berbasis ruang lingkup yang
                    disepakati.</span
                  ></span
                >
              </a>
              <a class="drop-link" href="{{ route('frontend.talent.job-connect') }}">
                ...
                <span
                  ...
                  ><span
                    >Menghubungkan kandidat dan peluang kerja yang
                    relevan.</span
                  ></span
                >
              </a>
          ...
          <div class="nav-item">
            <a class="nav-link" href="{{ route('frontend.home') }}#foundations"
              >Foundations <span class="chevron">▼</span></a
            >
            <div class="dropdown">
              <a class="drop-link" href="{{ route('frontend.foundation.education') }}">
                ...
                <span
                  ...
                  ><span
                    >Literasi, pengenalan karier, dan pembelajaran
                    industri.</span
                  ></span
                >
              </a>
              <a class="drop-link" href="{{ route('frontend.foundation.umkm') }}">
                ...
                <span
                  ...
                  ><span
                    >Penguatan kapasitas usaha dan literasi pengelolaan
                    bisnis.</span
                  ></span
                >
              </a>
        ...
        <div class="header-action">
          <a class="btn btn-outline btn-sm" href="{{ route('frontend.support.contact') }}"
            >Konsultasi</a
          >
