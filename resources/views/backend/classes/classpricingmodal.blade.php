					...
					<div class="row">
						...
						<div class="col-lg-10">
							<div class="form-group" hidden>
								...
								<small class="inputerrormessage text-danger" input-target="datPromoDateStart"
									style="display: none;"></small>
								<small class="inputerrormessage text-danger" input-target="datPromoDateEnd"
									style="display: none;"></small>
								<div class="input-group mb-4">
									<input type="date" class="form-control" name="datPromoDateStart"
										id="datPromoDateStart" placeholder="Promo Start" aria-label="Promo Start">
