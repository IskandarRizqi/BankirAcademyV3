                    ...
                    <div class="classEventContainer">
                        <div class="col-lg-12 text-right">
                            ...
                            <button type="button" class="btn btn-danger"
                                onclick="delClassEventRow($(this),{{ $v->id }})"><i class="bx bx-x"></i></button>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group ctrClassEventPassword">
                                    <label for="txtClassEventPassword">Password</label>
                                    <small class="inputerrormessage text-danger" input-target="txtClassEventPassword"
                                        style="display: none;"></small>
                                    <input type="text" name="txtClassEventPassword[]"
                                        class="txtClassEventPassword form-control" value="{{ $v->password_link }}">
                                </div>
                                <div class="form-group ctrClassEventLocation" style="display:none;">
                                    <label for="txtClassEventLocation">Location</label>
                                    <small class="inputerrormessage text-danger" input-target="txtClassEventLocation"
                                        style="display: none;"></small>
                            ...
                            <div class="col-lg-12">
                                ...
                                <small class="inputerrormessage text-danger" input-target="txaClassEventDescription"
                                    style="display: none;"></small>
                                <textarea type="text" name="txaClassEventDescription[]"
                                    class="txaClassEventDescription form-control">{{ $v->description }}</textarea>
                            </div>
                        </div>
                        <hr>
                    </div>
...
<script>
    function addNewClassEvent() {
            $('.dynamicClassEventForm').append("" +
                ...
                '			<div class="form-group ctrClassEventPassword">' +
                '				<label for="txtClassEventPassword">Password</label>' +
                '				<small class="inputerrormessage text-danger" input-target="txtClassEventPassword" style="display: none;"></small>' +
                '				<input type="text" name="txtClassEventPassword[]" class="txtClassEventPassword form-control">' +
                '			</div>' +
                '			<div class="form-group ctrClassEventLocation" style="display:none;">' +
                '				<label for="txtClassEventLocation">Location</label>' +
