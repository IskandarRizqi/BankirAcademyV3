		...
		<div class="widget">
			...
			<div class="widget-content">
				...
				<form action="/admin/classes/setevent" id="newClassEventForm" method="POST">
						...
						@foreach ($event as $v)
							<div class="classEventContainer">
								<div class="col-lg-12 text-right">
									<input type="hidden" name="txtClassEventId[]" class="form-control txtClassEventId" value="{{$v->id}}">
									<button type="button" class="btn btn-danger" onclick="delClassEventRow($(this),{{$v->id}})"><i class="bx bx-x"></i></button>
								</div>
								<div class="row">
									<div class="col-lg-4">
									...
									<div class="col-lg-8">
										<div class="form-group">
											...
											<div class="input-group mb-4">
												<input type="datetime-local" class="form-control datClassesDateStart" name="datClassesDateStart[]"  placeholder="Date Start" aria-label="Date Start" value="{{$v->time_start}}" required>
												<div class="input-group-append">
													<span class="input-group-text" id="basic-addon5">s/d</span>
												</div>
												<input type="datetime-local" class="form-control datClassesDateEnd" name="datClassesDateEnd[]"  placeholder="Date End" aria-label="Date End" value="{{$v->time_end}}" required>
											</div>
										</div>
									</div>
									<div class="col-lg-12">
										<div class="form-group ctrClassEventLink">
											...
											<input type="text" name="txtClassEventLink[]" class="txtClassEventLink form-control" value="{{$v->link}}">
										</div>
										<div class="form-group ctrClassEventLocation" style="display:none;">
											...
											<input type="text" name="txtClassEventLocation[]" class="txtClassEventLocation form-control" value="{{$v->location}}">
										</div>
									</div>
									<div class="col-lg-12">
					...
					<div class="row">
						<div class="col-lg-8">
							<button type="button" class="btn btn-block btn-info" onclick="addNewClassEvent()">Add New Event</button>
						</div>
						<div class="col-lg-4">
