...
<div class="col-lg-12">
	<div class="widget">
		...
		<div class="widget-content">
			<form action="/admin/classes" id="newClassesForm" method="POST" enctype="multipart/form-data" class="classes-form">
				@csrf
						...
						<div class="row">
							...
							<div class="col-lg-3">
								<div class="form-group">
									...
									<input type="time" name="jam_acara" id="jam_acara" class="form-control">
								</div>
							</div>
							<div class="col-lg-3">
								<div class="form-group classes-iht-field">
									...
									<div class="custom-control custom-switch classes-iht-switch">
										<input type="checkbox" class="custom-control-input" name="iht" id="chkClassesIht" value="1">
							...
							<div class="col-lg-3">
								<div class="form-group">
									...
									<textarea name="lokasi" id="lokasi" class="form-control" rows="1" cols="1" placeholder="Input lokasi class apabila offline"></textarea>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form-group">
