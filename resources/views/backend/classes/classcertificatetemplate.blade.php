...
<div class="col-lg-12">
	<div class="widget">
		...
		<div class="widget-content">
			<form action="/admin/classes/inputcertificatetemplate/{{$class->id}}" id="newClassesCertificatetempalteForm"
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="form-group">
							...
							<img src="{{(isset($certs->background)) ? '/'.$certs->background : '#'}}"
								alt="Image Preview" id="prvClassesImage" class="previewImage"
					...
					<div class="col-lg-12">
						<div class="form-group">
							...
							<div class="input-group mb-4">
								<input type="date" class="form-control" placeholder="Date Start" aria-label="Date Start"
									name="datCertificateCreated"
									value="{{(isset($certs->certificate_created)) ? $certs->certificate_created : ''}}">
								<div class="input-group-append">
									<span class="input-group-text">s/d</span>
								</div>
								<input type="date" class="form-control" placeholder="Date End" aria-label="Date End"
									name="datCertificateExpired"
									value="{{(isset($certs->certificate_expired)) ? $certs->certificate_expired : ''}}">
							</div>
						</div>
					</div>
					<div class="col-lg-12">
						<div class="form-group">
							<label>Content</label> &nbsp;<button type="button" class="btn btn-sm btn-info"
								onclick="openmodal('#classCertificateTemplateVariable')"><i
									class="bx bx-info-circle"></i></button>
							<textarea name="txaContent"
								id="txaContent">{{(isset($certs->content)) ? $certs->content : ''}}</textarea>
						</div>
					</div>
				</div>
	...
	<div class="modal fade modalwithselect2" id="classCertificateTemplateVariable" role="dialog"
		aria-labelledby="classCertificateTemplateVariableLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="classCertificateTemplateVariableLabel">Variabel</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"
						onclick="closemodal('#classCertificateTemplateVariable')">
				...
				<div class="modal-footer">
					<button class="btn" data-dismiss="modal"
						onclick="closemodal('#classCertificateTemplateVariable')"><i class="flaticon-cancel-12"></i>
						Close</button>
				</div>
			</div>
		</div>
