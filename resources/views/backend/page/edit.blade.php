                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select name="type" id="type" class="form-control">
                                    <option value="0"
                                        @if (isset($page->type)) {{ $page->type == 0 ? 'selected' : '' }} @endif>
                                        Blog</option>
                                    <option value="1"
                                        @if (isset($page->type)) {{ $page->type == 1 ? 'selected' : '' }} @endif>
                                        About</option>
                                    <option value="2"
                                        @if (isset($page->type)) {{ $page->type == 2 ? 'selected' : '' }} @endif>
                                        Contact</option>
                                    <option value="3"
                                        @if (isset($page->type)) {{ $page->type == 3 ? 'selected' : '' }} @endif>
                                        Syarat dan
                                        Ketentuan
                                    </option>
                                    <option value="4"
                                        @if (isset($page->type)) {{ $page->type == 4 ? 'selected' : '' }} @endif>
                                        Calon Bankir
                                    </option>
                                    <option value="5"
                                        @if (isset($page->type)) {{ $page->type == 5 ? 'selected' : '' }} @endif>
                                        Bankir</option>
                                    <option value="6"
                                        @if (isset($page->type)) {{ $page->type == 6 ? 'selected' : '' }} @endif>
                                        Bootcamp Bankir
                                    </option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" name="description" id="description" maxlength="255" required>{{ isset($page->description) ? $page->description : null }}</textarea>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>Content:</label>
                                <textarea name="txaPageAbout" id="txaPageAbout" class="form-control" required>{{ isset($page->content) ? $page->content : null }}</textarea>
                            </div>
                        </div>
                        <div class="col-lg-12">
