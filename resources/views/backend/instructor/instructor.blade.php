                            ...
                            <div class="row m-2">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" id="desc" name="desc" required>{{ old('desc') }}</textarea>
                                        @error('desc')
                                            <span class="text-danger" role="alert">
                                                <strong>Harap Diisi</strong>
                                            </span>
