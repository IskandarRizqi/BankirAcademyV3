<div class="modal fade modalwithselect2" id="classContentModal" role="dialog" aria-labelledby="classContentModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                    onclick="closemodal('#classContentModal')">
            ...
            <div class="modal-body">
                ...
                <form action="/admin/classes/setcontent" id="newClassesForm" method="POST"
                    ...
                    <div class="col-lg-12">
                        <button type="button" class="btn btn-block btn-primary"
                            onclick="addNewClassContentRow()">+</button>
                    </div>
                    <hr>
                    <button class="btn" data-dismiss="modal" onclick="closemodal('#classContentModal')"><i
