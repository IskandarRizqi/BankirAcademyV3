...
<div class="col-lg-12">
    <div class="widget">
        <div class="widget-heading">
            <a class="btn" data-dismiss="modal" href="/instructor/classes"><i class="flaticon-cancel-12"></i> Back</a>
        </div>
        <div class="widget-content">
            <form action="/instructor/classes/store" id="newClassesForm" method="POST" enctype="multipart/form-data">
                @csrf
