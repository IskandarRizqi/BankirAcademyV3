        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
            <div class="widget widget-card-one">
                ...
                <div class="widget-content">
                    <div class="row">
                        <input type="text" id="id" name="id" value="{{isset($data)?$data->id:null}}" hidden />
                        ...
                        <div class="col-6 form-group">
                            ...
                            <textarea type="text" id="alamat" name="alamat"
                                class="form-control">{{isset($data)?$data->alamat:''}}</textarea>
                            @error('alamat')
                            <small class="text-danger">Harus Diisi</small>
                            @enderror
                        </div>
                        <div class="col-6 form-group">
                            ...
                            <textarea type="text" id="deskripsi" name="deskripsi"
                                class="form-control"> {{isset($data)?$data->desc:''}}</textarea>
                            @error('deskripsi')
                            <small class="text-danger">Harus Diisi</small>
                            @enderror
                        </div>
