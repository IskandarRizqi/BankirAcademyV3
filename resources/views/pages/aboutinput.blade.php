				...
				<div class="row">
					<div class="col-lg-6">
						<div class="form-group">
							<label>Title:</label>
							<input type="text" class="form-control" name="txtTitle" id="txtTitle" value="{{isset($about->title)?$about->title:null}}">
						</div>
					</div>
					<div class="col-lg-6">
						<div class="form-group">
							...
							<img src="{{isset($about->thumbnail)?$about->thumbnail:'#'}}" alt="Image Preview" id="prvImage" class="previewImage" style="max-width: 100%;max-height:97px;">
						</div>
					</div>
					<div class="col-lg-12">
						<div class="form-group">
