                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" name="txtdescription" id="txtdescription" maxlength="500" required>{{ isset($blog->description) ? $blog->description : null }}</textarea>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
