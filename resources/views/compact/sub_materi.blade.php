...
@section('content')
            ...
            <div class="widget-content widget-content-area br-6 shadow-sm bg-white p-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        ...
                        <p class="text-muted mb-0" style="font-size: 13px;">Kelola materi perkuliahan, tipe akses, harga, dan
                            file lampiran.</p>
                    </div>
                    <button type="button" class="btn btn-primary px-4" data-toggle="modal" data-target="#userModal"
                        onclick="resetForm()">
                        ...
                        <tbody>
                            @forelse($data as $key => $x)
                                <tr>
                                    ...
                                    <td>
                                        <div style="font-weight: 600; color: #3b3f5c; font-size: 14px;">{{ $x->nama }}
                                        </div>
                                            ...
                                            @foreach ($x->items as $item)
                                                <li class="mb-2 d-flex align-items-center">
                                                    @if ($item->tipe_link_item == 1)
                                                        <span class="badge badge-danger mr-2 text-uppercase"
                                                            style="font-size: 9px; padding: 2px 5px; font-weight: 700;">PDF</span>
                                                    @else
                                                        <span class="badge badge-primary mr-2 text-uppercase"
                                                            style="font-size: 9px; padding: 2px 5px; font-weight: 700;">Video</span>
                                                    @endif
                                                    <a href="{{ $item->link_item }}" target="_blank"
                                                        style="font-weight: 500; color: #4361ee; text-decoration: none; font-size: 13px;"
                                    ...
                                    <td>
                                        @if ($x->tipe_beasiswa == 0)
                                            <span class="badge badge-pills badge-info mb-1"
                                                style="font-size: 11px;">Semua</span>
                                        @elseif($x->tipe_beasiswa == 1)
                                            <span class="badge badge-pills badge-success mb-1"
                                                style="font-size: 11px;">Beasiswa</span>
                                        @elseif($x->tipe_beasiswa == 2)
                                            <span class="badge badge-pills badge-warning text-white mb-1"
                                                style="font-size: 11px;">Non Beasiswa</span>
                                        @endif
                                    ...
                                    <td>
                                        <div style="font-weight: 700; color: #1abc9c; font-size: 14px;">Rp
                                            {{ number_format($x->harga_final) }}</div>
                                        @if ($x->diskon > 0)
                                            <div class="d-flex align-items-center mt-1" style="gap: 5px;">
                                                <small class="text-muted text-strikethrough"
                                                    style="text-decoration: line-through; font-size: 11px;">Rp
                                                    {{ number_format($x->harga) }}</small>
                                                <span class="badge badge-light-danger"
                                                    style="font-size: 9px; padding: 1px 4px; font-weight: bold;">-{{ $x->diskon }}%</span>
                                            </div>
                                        @endif
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown custom-dropdown">
                                            <a class="dropdown-toggle" href="#" role="button"
                                                id="dropdownMenuLink{{ $x->id }}" data-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    fill="none" stroke="currentColor" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round"
                                                    class="feather feather-more-horizontal text-muted">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right"
                                                aria-labelledby="dropdownMenuLink{{ $x->id }}">
                                                <a class="dropdown-item action-edit" href="javascript:void(0);"
                                                    onclick="editUser({{ json_encode($x->load('items')) }})">
                                                    ⚙️ Edit Data
                                                </a>
                                                <div class="dropdown-divider"></div>
                                                <form action="/sub-materi/{{ $x->id }}" method="POST"
                                                    onsubmit="return confirm('Apakah Anda yakin ingin menghapus materi ini beserta seluruh filenya?')">
                                                    @csrf
                                                    @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center text-muted p-5">Tidak ada data materi ditemukan.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content"
                ...
                <div class="modal-header" style="border-bottom: 1px solid #f1f2f3;">
                    <h5 class="modal-title" id="userModalLabel" style="font-weight: 700; color: #3b3f5c;">Form Pengisian
                        Materi</h5>
                    ...
                    <div class="modal-body p-4">
                        <div class="row">
                            <div class="form-group col-lg-5 mb-3">
                                ...
                                <select name="id_materi" id="id_materi" class="form-control" style="width:100%;"
                                    required>
                                    <option value="" disabled selected>-- Pilih Kompetensi --</option>
                                    @foreach ($materi as $v)
                                        <option value="{{ $v->id }}" data-nama="{{ $v->nama }}">
                                            {{ $v->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-lg-12 mb-4 mt-2">
                                <div class="d-flex justify-content-between align-items-center p-3 mb-3"
                                    style="background-color: #f4f6fd; border-radius: 8px; border-left: 4px solid #4361ee;">
                                    <div>
                                        <label class="mb-0"
                                            style="font-weight: 700; color: #4361ee; font-size: 14px;">Daftar File / Video
                                            Materi</label>
                                        <small class="text-muted d-block">Sematkan dokumen PDF atau URL video pembelajaran
                                            terkait.</small>
                                    </div>
                                    <button type="button" class="btn btn-sm btn-primary px-3" onclick="addItemRow()">+
                                        Tambah Baris Link</button>
                                </div>
                            ...
                            <div class="form-group col-lg-12 mb-4">
                                <label style="font-weight: 600; color: #515365; display: block;" class="mb-2">Status
                                    Upcoming (Materi Mendatang)</label>
                                <div class="d-flex align-items-center" style="gap: 20px;">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="upcoming0" name="upcoming"
                                            class="custom-control-input" value="0" checked>
                                        <label class="custom-control-label" for="upcoming0"
                                            style="cursor: pointer;">Tidak (Materi Aktif)</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="upcoming1" name="upcoming"
                                            class="custom-control-input" value="1">
                                        <label class="custom-control-label" for="upcoming1" style="cursor: pointer;">Ya
                                            (Materi Mendatang / Upcoming)</label>
                                    </div>
                                </div>
                            </div>

                            <div class="form-group col-lg-12 mb-4">
                                <label style="font-weight: 600; color: #515365; display: block;" class="mb-2">Tipe Akses
                                    materi</label>
                                <div class="d-flex align-items-center" style="gap: 20px;">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="tipe_beasiswa0" name="tipe_beasiswa"
                                            class="custom-control-input" value="0" checked>
                                        <label class="custom-control-label" for="tipe_beasiswa0"
                                            style="cursor: pointer;">Terbuka Untuk Semua</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="tipe_beasiswa1" name="tipe_beasiswa"
                                            class="custom-control-input" value="1">
                                        <label class="custom-control-label" for="tipe_beasiswa1"
                                            style="cursor: pointer;">Khusus Beasiswa</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="tipe_beasiswa2" name="tipe_beasiswa"
                                            class="custom-control-input" value="2">
                                        <label class="custom-control-label" for="tipe_beasiswa2"
                                            style="cursor: pointer;">Non Beasiswa (Mandiri)</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-lg-12 mb-3" id="container-thumbnail" style="display: none;">
                                ...
                                <div id="preview-wrapper" class="p-2 border rounded align-items-center"
                                    style="display: none; background-color: #f8f9fa; gap: 12px;">
                                    <img id="img-preview" src="" alt="Thumbnail"
                                        style="max-height: 80px; width: 120px; object-fit: cover;" class="rounded border">
                                    <div>
                                    ...
                                    <button type="button" class="btn btn-sm btn-link text-danger ml-auto"
                                        onclick="clearSelectedPhoto()">Hapus</button>
                                </div>
                            </div>

                            <!-- Sub-Modal: Modal Pemilih Galeri Foto (Photo Picker) -->
                            <div class="modal fade" id="photoPickerModal" tabindex="-1" role="dialog"
                                aria-hidden="true" style="z-index: 1060;">
                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" style="font-weight: 700;">Galeri Photo</h5>
                                            <!-- GANTI data-dismiss dengan onclick khusus -->
                                            <button type="button" class="close" onclick="closePhotoPicker()"
                                                aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body p-3">
                                            <!-- Search Box -->
                                            <div class="mb-3">
                                                <input type="text" id="searchPhotoInput" class="form-control"
                                                    placeholder="Cari nama/title foto..." onkeyup="filterPhotos()">
                                            </div>

                                            <!-- Grid Photo Galeri -->
                                            <div class="row" id="photo-gallery-container"
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-secondary btn-sm"
                                                onclick="closePhotoPicker()">Tutup</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-lg-4 mb-3">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text bg-light"
                                            style="border-right: none;">Rp</span></div>
                                    <input type="text" name="harga" id="harga_format" class="form-control"
                            ...
                            <div class="form-group col-lg-4 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" min="0" max="100" name="diskon" id="diskon"
                                        class="form-control" placeholder="0" required>
                                    <div class="input-group-append"><span class="input-group-text bg-light">%</span></div>
                                </div>
                                <small id="harga_final" class="form-text text-success mt-1"
                                    style="font-weight: 700; font-size: 12px;">harga final : Rp 0</small>
                            </div>
                            <div class="form-group col-lg-4 mb-3">
                            ...
                            <div class="form-group col-lg-12 mb-0">
                                ...
                                <textarea name="keterangan" id="keterangan" cols="30" rows="3" class="form-control"
                                    placeholder="Catatan internal singkat mengenai materi ini..."></textarea>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        // Mencegah Event Hide pada Photo Picker merembet ke User Modal
        $('#photoPickerModal').on('hide.bs.modal', function(e) {
            e.stopPropagation();
        });

        // Menjaga agar class 'modal-open' dan scrollbar tetap ada di Body saat Sub-Modal ditutup
        $('#photoPickerModal').on('hidden.bs.modal', function(e) {
            e.stopPropagation();
