...
@section('content')
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        @if (auth()->user()->email === 'cb@bankir.academy' || in_array(auth()->user()->role, [4, 5]))
                            ...
                            <button type="button"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="feather feather-file-plus mr-2">
                                ...
                                <tr class="user-row">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="mb-0 font-weight-bold text-dark user-name-text">
                                                    {{ $user->name }}</p>
                                                @if ($user->role == 6 && isset($user->siswa->nisn))
                                                    <span
                                                        class="badge badge-light-secondary text-muted small px-2 py-0">NISN:
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center text-muted small">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                                ...
                                                class="feather feather-mail mr-2 text-primary">
                                                <path
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="badge badge-pill text-dark bg-light px-3 py-1">Role
                                                {{ $user->role }}</span>
                                        @endif
                                    </td>
                                    <td class="text-right">
                                        <div class="dropdown d-inline-block">
                                            <button class="btn btn-link text-muted p-0 dropdown-toggle no-caret"
                                                type="button" id="dropdownMenuLink{{ $user->id }}"
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right shadow border-0 py-2 animated font-small"
                                                ...
                                                <form action="{{ route('users.destroy', $user->id) }}" method="POST"
                                                    ...
                                                    @method('DELETE')
                                                    <button type="button"
                                                        class="dropdown-item py-2 text-danger btn-delete-user"
                                                        data-name="{{ $user->name }}"
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <button type="button" id="btn-bulk-whatsapp-floating"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                    ...
                                    stroke-linecap="round" stroke-linejoin="round" class="feather feather-send mr-2">
    ...
    <div class="modal fade" id="selectedUsersModal" tabindex="-1" role="dialog"
        aria-labelledby="selectedUsersModalLabel" aria-hidden="true">
            ...
            <div class="modal-content"
                ...
                <form id="userForm" action="{{ route('users.store') }}" method="POST">
                    ...
                    <div class="modal-body" style="padding: 24px; max-height: calc(100vh - 200px); overflow-y: auto;">
                        <div class="alert alert-light-info d-none mb-4 p-3 d-flex align-items-start"
                            id="siswa-account-info"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="mr-2 mt-1">
                                <circle cx="12" cy="12" r="10"></circle>
                                <line x1="12" y1="16" x2="12" y2="12"></line>
                                <line x1="12" y1="8" x2="12.01" y2="8"></line>
                            </svg>
                            <div style="font-size: 13px; color: #004085;">
                                <strong style="display:block; margin-bottom: 4px;">Informasi Pembuatan Akun
                                    Peserta:</strong>
                                <div class="row mt-2">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group mb-3">
                                <label for="name" style="font-weight: 600; color: #3b3f5c; font-size: 13px;">Nama
                                    Lengkap
                                    <span class="text-danger">*</span></label>
                                <input type="text" id="name" name="name" class="form-control style-input"
                                    required placeholder="Masukkan nama lengkap" style="border-radius: 6px;">
                            </div>

                            <div class="col-md-6 form-group mb-3">
                                <label for="role" style="font-weight: 600; color: #3b3f5c; font-size: 13px;">Role /
                                    Hak
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group mb-3" id="email-group">
                                <label for="email" style="font-weight: 600; color: #3b3f5c; font-size: 13px;">Alamat
                                    Email
                                    <span class="text-danger">*</span></label>
                                <input type="email" id="email" name="email" class="form-control style-input"
                                    required placeholder="name@example.com" style="border-radius: 6px;">
                            </div>
                            ...
                            <div class="col-md-6 form-group mb-3" id="password-group">
                                ...
                                <div class="input-group">
                                    <input type="password" id="password" name="password"
                                        class="form-control style-input" placeholder="Minimal 8 karakter"
                                    ...
                                    <div class="input-group-append">
                                        <button
                                            ...
                                            <svg id="eye-icon" xmlns="http://www.w3.org/2000/svg" width="18"
                                                height="18" viewBox="0 0 24 24" fill="none" stroke="#515365"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                                <circle cx="12" cy="12" r="3"></circle>
                                            </svg>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group mb-3 d-none" id="membership-group">
                                <label for="membership_id"
                                    style="font-weight: 600; color: #3b3f5c; font-size: 13px;">Membership
                                    (Opsional)</label>
                            ...
                            <div class="col-md-6 form-group mb-3 d-none" id="bank-group">
                                <label for="bank_id" style="font-weight: 600; color: #3b3f5c; font-size: 13px;">Pilih
                                    Bank
                                    <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 form-group mb-3 d-none" id="sekolah-group">
                                ...
                                <select id="sekolah_id" name="sekolah_id" class="form-control style-input"
                                    ...
                                    @foreach ($listSekolah as $sekolah)
                                        <option value="{{ $sekolah->id }}" data-bank="{{ $sekolah->bank_id }}">
                                            {{ $sekolah->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div id="siswa-profile-group" class="d-none mt-3 pt-3" style="border-top: 1px dashed #e0e6ed;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    <label for="nisn" style="font-weight: 600; color: #3b3f5c; font-size: 13px;">NISN
                                        <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group mb-3">
                                    <label for="beasiswa"
                                        style="font-weight: 600; color: #3b3f5c; font-size: 13px;">Status
                                        Beasiswa</label>
                                ...
                                <div class="col-md-4 form-group mb-3">
                                    ...
                                    <input type="number" id="angkatan" name="angkatan"
                                        class="form-control style-input" placeholder="2023" style="border-radius: 6px;">
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea id="alamat" name="alamat" class="form-control style-input" rows="2"
                                    placeholder="Masukkan alamat lengkap tempat tinggal" style="border-radius: 6px; resize: none;"></textarea>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            checkboxes.forEach(cb => {
                cb.addEventListener('change', function() {
                    ...
                    if (document.querySelectorAll('.user-checkbox:checked').length === checkboxes
                        .length && checkAll) {
            ...
            if (btnBulkWaFloating) {
                btnBulkWaFloating.addEventListener('click', function() {
                    const selectedIds = Array.from(document.querySelectorAll('.user-checkbox:checked')).map(
                        cb => cb.value);
                        ...
                        fetch("{{ route('users.send-bulk-wa') }}", {
                            ...
                            .then(data => {
                                if (data.success) {
                                    ...
                                    Swal.fire('Gagal!', data.message || 'Error antrean Fonnte API.',
                                        'error');
                                }
                            })
                            .catch(error => {
                                Swal.fire('Koneksi Gagal!', 'Terjadi kendala jaringan dengan server.',
                                    'error');
                            });
                    }
                });
        ...
        function viewUser(user) {
            ...
            if (user.role == 4) {
                ...
                if (user.siswa) {
                    ...
                    document.getElementById('view-jk').innerText = user.siswa.jenis_kelamin === 'L' ? 'Laki-laki' : (user
                    ...
                    document.getElementById('view-beasiswa').innerText = user.siswa.beasiswa ? 'Ya (Penerima Beasiswa)' :
                        'Tidak';
                } else {
        ...
        function handleRoleChange() {
            ...
            if (role == "4") {
                ...
                if (AUTH_EMAIL === 'cb@bankir.academy' || AUTH_EMAIL === 'root@root.root') {
        ...
        function getFilteredCheckboxes() {
            if (userDataTable) {
                return $(userDataTable.rows({
                    search: 'applied'
                }).nodes()).find('.user-select-checkbox');
            }
        ...
        function renderSelectedUsersPreview() {
            ...
            $('#selected-users-preview-body').html(rows ||
                '<tr><td colspan="4" class="text-center">Tidak ada data dipilih.</td></tr>');
        }
    </script>
@endsection
