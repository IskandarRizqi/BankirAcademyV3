        ...
        @forelse($kategori as $kat)
            ...
            <div class="mb-5">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div class="flex-grow-1 border-top" style="border-color: #E7E9F0 !important;"></div>
                </div>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card h-100 course-card">
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <h4 class="card-title font-weight-bold mb-2">{{ $mat->nama }}</h4>
                                    <p class="card-text text-muted small flex-grow-1">
                                        {{ Str::limit($mat->keterangan ?? 'Tidak ada keterangan materi.', 100) }}
                                    </p>
                                    <div class="border-top pt-3 d-flex flex-column flex-sm-row justify-content-between align-items-sm-center" style="border-color: #E7E9F0 !important;">
